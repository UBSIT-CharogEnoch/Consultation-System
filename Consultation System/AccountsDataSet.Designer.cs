...
namespace Consultation_System {
    ...
    public partial class AccountsDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountsRow AddAccountsRow(int Id, string Username, string Password, string AccessLevel) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public string AccessLevel {
                get {
                    try {
                        return ((string)(this[this.tableAccounts.AccessLevelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'AccessLevel\' in table \'Accounts\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAccounts.AccessLevelColumn] = value;
                }
            }
            ...
            public bool IsAccessLevelNull() {
                return this.IsNull(this.tableAccounts.AccessLevelColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetAccessLevelNull() {
                this[this.tableAccounts.AccessLevelColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Consultation_System.AccountsDataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Accounts] ([Id], [Username], [Password], [AccessLevel]) VALUES" +
                " (@Id, @Username, @Password, @AccessLevel);\r\nSELECT Id, Username, Password, Acce" +
                "ssLevel FROM Accounts WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Accounts] SET [Id] = @Id, [Username] = @Username, [Password] = @Password, [AccessLevel] = @AccessLevel WHERE (([Id] = @Original_Id) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_AccessLevel = 1 AND [AccessLevel] IS NULL) OR ([AccessLevel] = @Original_AccessLevel)));
SELECT Id, Username, Password, AccessLevel FROM Accounts WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Password, AccessLevel FROM dbo.Accounts";
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_Password, string Original_AccessLevel) {
        ...
        public virtual int Insert(int Id, string Username, string Password, string AccessLevel) {
        ...
        public virtual int Update(int Id, string Username, string Password, string AccessLevel, int Original_Id, string Original_Username, string Original_Password, string Original_AccessLevel) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string AccessLevel, int Original_Id, string Original_Username, string Original_Password, string Original_AccessLevel) {
